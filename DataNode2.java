...
public class DataNode2 extends UnicastRemoteObject implements DataNodeIF {

	public DataNode2() throws RemoteException{
		super();
	}
	...
	public static void main(String args[])
	{
		try {
            ...
            DataNode2 servidor = new DataNode2();
            Naming.bind("Datanode2", servidor);
            System.err.println("Datanode2 pronto para uso.");
